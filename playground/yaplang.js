...
var BuiltinFunction = class {
  constructor(name, arityValue, impl) {
    ...
    __publicField(this, "arityValue", arityValue);
    __publicField(this, "impl", impl);
    __publicField(this, "isYapCallable", true);
  }
  arity() {
...
var YapFunction = class {
  constructor(declaration, closure, interpreter) {
    __publicField(this, "declaration", declaration);
    __publicField(this, "closure", closure);
    __publicField(this, "interpreter", interpreter);
    __publicField(this, "isYapCallable", true);
